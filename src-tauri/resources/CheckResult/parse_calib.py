...
def generate_report(device_uid, cameras, imu, log_data, xml_missing_checks=None):
    ...
    overall, _, _ = resolve_status_and_exit_code(log_data, imu, xml_missing_checks)
